...
public class UsuarioRepository extends Repository<Usuario>{
	...
	public Usuario getByUserAndPassword(Usuario usuario) {
		String query = "SELECT * FROM t_Usuario WHERE NombreUsuario LIKE ? AND Password LIKE ?";
